...
sentence_count = 0
s_count = 0
$LOG = Logger.new('this_month1.log', 'monthly')
begin
...
$LOG.debug("Char count excluding spaces: #{char_count_without_spaces}")
...
$LOG.debug("Sentence count: #{s_count}")
$LOG.debug("Average words: #{avg_words}")
$LOG.debug("Average sentences: #{avg_sentences}")
